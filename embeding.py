'''
This code is a modified version for creating Chinese emotional embeddings.
The original code is developed by Armin Seyeditabari & Narges Tabari.
New version: developed by Chenglin Jiang (cljiangjiang@gmail.com), inspired by Seyeditabari, A., Tabari, N., Gholizadeh, S., & Zadrozny, W. (2019). 
Emotional Embeddings: Refining Word Embeddings to Capture Emotional Content of Words. arXiv preprint arXiv:1906.00112.
'''
import configparser
import numpy
import sys
...
class ExperimentRun:
	...
	def __init__(self):
		...
		self.pretrained_vectors_filepath = '/Users/jiangchenglin/Desktop/desktop/Emotional-Embedding-master/data/vectors/Tencent_AILab_ChineseEmbedding/Tencent_AILab_ChineseEmbedding.txt'
		vocabulary_filepath = '/Users/jiangchenglin/Desktop/desktop/Emotional-Embedding-master/data/constraints/dictionary.txt'
		...
		synonym_list = ['/Users/jiangchenglin/Desktop/desktop/Emotional-Embedding-master/data/constraints/posEmotionList.txt']
		antonym_list = ['/Users/jiangchenglin/Desktop/desktop/Emotional-Embedding-master/data/constraints/negEmotionList.txt']
...
def print_word_vectors(word_vectors, write_path):
	...
	with open(write_path, "w") as f_write:
		for key in word_vectors:
			print(key, " ".join(map(lambda x:str(x), numpy.round(word_vectors[key], decimals=6))) , file = f_write)
...
def run_experiment():
	...
	results directory.
	"""
	current_experiment = ExperimentRun()
	...
	'''
	emotion_importance = 3 # 和梯度关联
	for i in range(2, emotion_importance):
